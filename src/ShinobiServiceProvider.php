...
class ShinobiServiceProvider extends ServiceProvider
{
    ...
    protected function registerMiddlewares(): void
    {
        ...
        if ($router) {
            $router->aliasMiddleware('role', \Ronin\Middleware\UserHasRole::class);
            $router->aliasMiddleware('roles.all', \Ronin\Middleware\UserHasAllRoles::class);
            $router->aliasMiddleware('roles.any', \Ronin\Middleware\UserHasAnyRole::class);
            $router->aliasMiddleware('permission', \Ronin\Middleware\UserHasPermission::class);
            $router->aliasMiddleware('permissions.all', \Ronin\Middleware\UserHasAllPermissions::class);
            $router->aliasMiddleware('permissions.any', \Ronin\Middleware\UserHasAnyPermission::class);
            $router->aliasMiddleware('role_or_permission', \Ronin\Middleware\RoleOrPermission::class);
        }
    }
}
