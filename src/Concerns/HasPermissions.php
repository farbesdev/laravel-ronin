...
namespace Ronin\Concerns;

use Illuminate\Support\Arr;
use Illuminate\Database\Eloquent\Model;
use Ronin\Facades\Shinobi;
use Ronin\Contracts\Permission;
use Illuminate\Database\Eloquent\Relations\BelongsToMany;
use Ronin\Exceptions\PermissionNotFoundException;
use Ronin\Guard;
use Ronin\CacheRegistry;
...
trait HasPermissions
{
    ...
    public function forgetCachedPermissions(): void
    {
        ...
        if (config('ronin.cache.enabled')) {
            $prefix = config('ronin.cache.prefix', 'ronin');
            if ($this instanceof \Ronin\Contracts\Role) {
     ...
     * 
     * @param  \Ronin\Models\Permission  $permission
