...
namespace Laravel\Ronin\Events;
 ...
 * - Audit trails
 *
 * @see \Laravel\Ronin\Middleware\UserHasRole
 * @see \Laravel\Ronin\Middleware\UserHasAllRoles
 * @see \Laravel\Ronin\Middleware\UserHasAnyRole
 */
