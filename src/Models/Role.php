...
use Ronin\Concerns\HasPermissions;
use Ronin\Contracts\Role as RoleContract;
 ...
 *
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Ronin\Models\Permission> $permissions
 */
