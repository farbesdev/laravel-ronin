...
name: php-pro
description: >
  Experto en construcción de aplicaciones PHP con características modernas de PHP 8.3+, Laravel
  o Symfony. Aplica tipado estricto, PHPStan nivel 9, patrones async con Swoole y estándares PSR.
  Crea controladores, configura middlewares, genera migraciones, escribe pruebas PHPUnit/Pest,
  define DTOs y Value Objects tipados, configura inyección de dependencias y crea APIs REST.
  Usar cuando se trabaje con Eloquent, Doctrine, Composer, Psalm, ReactPHP o cualquier desarrollo
  de API PHP.
license: MIT
metadata:
