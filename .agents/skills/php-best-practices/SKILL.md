...
description: >
  Experto en patrones modernos de PHP 8.x, estándares PSR y principios SOLID. Usar cuando se
  revise código PHP, se verifique la seguridad de tipos, se audite la calidad del código o se
  garanticen las buenas prácticas PHP. Activa en "revisar PHP", "auditar PHP", "código PHP",
  "estándares PSR", "SOLID en PHP" o "buenas prácticas PHP".
license: MIT
metadata:
